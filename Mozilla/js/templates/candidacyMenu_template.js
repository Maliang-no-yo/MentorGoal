...
//get candidacies 
var candidacies;
browser.storage.sync.get(["candidacies"], function(result) {
...
//get contacts
var contacts;
browser.storage.sync.get(["contacts"], function(result) {
    if (result["contacts"]==null){
        candidacies=[];
    } else { 
        candidacies=result["contacts"];
    }
});
...
function saveCandidacy() {
    ...
    browser.storage.sync.set({candidacies:candidacies}, function() {
